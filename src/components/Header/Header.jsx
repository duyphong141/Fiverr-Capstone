...
export default function Header(props) {
    ...
    const renderLogin = () => {
                ...
                <ul>
                        ...
                        <div className="messages-wrapper">
                            <div className="W46fKfn cK9KPQl HPiYJFP popover-notifications-drawer popover-notifications-drawer-light popover-bell-drawer">
                                <button className='button-icon'>
                                    <img src="https://fiverr-res.cloudinary.com/npm-assets/layout-server/bell.78d6546.svg" className="notifications-drawer-bell-trigger" alt="Notifications" />
                    ...
                    <li className='display-from-md'>
                        <div className="messages-wrapper">
                            <div className="W46fKfn cK9KPQl HPiYJFP popover-notifications-drawer popover-notifications-drawer-light popover-bell-drawer">
                                <button className='button-icon'>
                                    <img src="https://fiverr-res.cloudinary.com/npm-assets/layout-server/letter.07c989b.svg" className="notifications-drawer-letter-trigger" alt="Messages" />
                                </button>
                            </div>
                        </div>
                    </li>
        ...
        return <nav>
            <ul className='d-flex'>
                ...
                <li className='d-flex english-usd'>
                    <div className='left'>
    ...
    const renderAdmin = () => {
        if (JSON.parse(localStorage.getItem(USERLOGIN)).user.role === "ADMIN") {
            return <a className="dropdown-item" href="#">Admin</a>
        }
    }

    return (
        <div className={'main-header ' + styleHeader}>
            <div className={"thanh-header-top container-fluid " + cls}>
                <div className="thanh-header d-flex container-fluid">

...
import { LayBinhLuanTheoCVAction } from '../../../redux/action/action';
...
export default function SellerReview(props) {
    ...
    useEffect(() => {
        ...
        promise.then((result) => {
            // console.log("Lấy bình luận thành công", result.data.content);
    ...
    // let getAPILayBinhLuanTheoCV = (MaCongViec) => {
    //     return () => {
    //         LayBinhLuanTheoCVAction
    //         .then((result) => {
    //             console.log("Lấy bình luận thành công", result.data.content);
    //             setLayBinhLuanTheoCV = result.data.content;
    //         })
                    ...
                    <div className='review-bottom-left' >
                        <div className='d-flex align-items-center'>
                            ...
                            <div className='hr-review'>
                                <hr className=' ml-3' color='#ffb33e' />
                            </div>
                            <p>(333)</p>
                        </div>
                        <div className='d-flex align-items-center'>
                            <p > 4 stars</p>
                            <div className='hr-review' >
                                <hr className=' ml-3' width="5%" color='#ffb33e' />
                            </div>
                            <p>(2)</p>
                        </div>
                        <div className='d-flex align-items-center'>
                            <p > 3 stars</p>
                            <div className='hr-review' >
                                <hr className=' ml-3' width="90%" color='#e4e5e7' />
                            </div>
                            <p>(0)</p>
                        </div>
                        <div className='d-flex align-items-center'>

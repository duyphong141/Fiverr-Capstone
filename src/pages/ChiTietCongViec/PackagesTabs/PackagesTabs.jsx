    ...
    return <div className='packagestabs mt-5 mb-5 ' >
        ...
        <div className="tab-content container mt-4" id="myTabContent">
            <div className="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                ...
                <div className='mt-5'>
                    <ul className='flex-column delivery-wrapper'>
                        <li>
                            <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M8 0C3.6 0 0 3.6 0 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8zm0 14c-3.3 0-6-2.7-6-6s2.7-6 6-6 6 2.7 6 6-2.7 6-6 6z"></path><path d="M9 4H7v5h5V7H9V4z"></path></svg> 14 Days Delivery
                        </li>
                ...
                <button onClick={handleSubmit} className='btn btn-success btn-block mt-5' > Continue($)</button>
            ...
            <div className="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                ...
                <button className=' btn btn-success btn-block mt-5' > Continue($)</button>
            </div>
